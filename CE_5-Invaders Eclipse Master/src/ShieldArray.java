class ShieldArray {
  ...
  public ShieldArray(int xStart, int yStart, int spacing, int shieldCount, PApplet audio) {
    xPos = xStart;
    yPos = yStart;
  ...
  public void initArray(int xStart, int yStart, int spacing, PApplet audio) {
  ...
  public void collided(BulletStream bulletStream, BombArray bombArray) {
    for(int shieldNum = 0; shieldNum < shieldArray.length; shieldNum++){
  ...
  public void draw(BulletStream bulletStream, BombArray bombArray){
    for(int shieldNum = 0; shieldNum < shieldArray.length; shieldNum++){
